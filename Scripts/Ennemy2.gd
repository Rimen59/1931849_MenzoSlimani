...
onready var canon2 = $Cannon2
onready var canon3 = $Cannon3
...
func _on_Timer_timeout():
	...
	var c = balle.instance()
	var d = balle.instance()
	shootfx.play()
	b.creer(canon.global_position, rotation)
	c.creer(canon2.global_position, rotation - deg2rad(10))
	d.creer(canon3.global_position, rotation + deg2rad(10))
